...
public class uploadMenuImage extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            upload(request, response, multipartRequest, categoryId, name, price, description);
        } 
        catch(Exception e) {
    ...
    private void upload(HttpServletRequest request, HttpServletResponse response, MultipartRequest multipartRequest,
            String categoryId, String name, String price, String description) throws IOException, Exception {
        // Get uploaded file
        ...
        if (tmpFile != null) {
             ...
             */
            tmpFile.delete();
            new MenuModel().addMenu(categoryId, name, price, description, newFileName);
        }
        else {
            new MenuModel().addMenu(categoryId, name, price, description);
        }
        /**
